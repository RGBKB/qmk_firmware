...
typedef struct {
	...
	uint8_t position_section_first_touched[TOUCH_SEGMENTS] = { 0 }; // Used to initiate swipes slightly quicker
...
half_touch_status_t touch_half_state_j         = { 0, 0, 0, 0, 0, 0, 0, 0, 0 }; // Used on both halves (separately)
